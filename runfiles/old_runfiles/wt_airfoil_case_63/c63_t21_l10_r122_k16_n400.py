...
if rank == 0:
    ...
    for i in range(0,N_pop-len(pop)): 
        pop += [[random.uniform(0.05,0.8)] + [random.uniform(-0.2,0.8) for j in range(0,int(N_k/2)-1)]   +   [random.uniform(-0.8,-0.05)] + [random.uniform(-0.8,0.4) for j in range(0,int(N_k/2)-1)] ] 
