...
def airfoil_fitness(x):
    ...
    try:
        ...
        rough_to_clean_mulFactor            = 8
        clean_LoD_weighting                 = 0.75
        ...
        max_thickness_lower_weighting       = 10*constraint_base_penalty
        ...
        te_cone_violation_weighting         = 100*constraint_base_penalty
        ...
        obj += clean_LoD_weighting*-1*(LoD_clean_at_design_alpha)
        obj += rough_LoD_weighting*-1*(LoD_rough_at_design_alpha)
