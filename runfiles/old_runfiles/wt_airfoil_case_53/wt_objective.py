...
def airfoil_fitness(x):
    ...
    try:
        ...
        max_thickness_loc_upper                  = 0.30
        max_thickness_loc_lower                  = 0.25
        ler_skew_factor                          = 1.9
        cone_angle                               = 10
        te_frac                                  = 0.95
        ...
        max_thickness_weighting             = 10*constraint_base_penalty
        max_thickness_upper_weighting       = 10*constraint_base_penalty
        max_thickness_lower_weighting       = 50*constraint_base_penalty
        ...
        upper_10deg_cone = midpoint_at_98_percent + np.tan(cone_angle/2/180*np.pi)*(1-te_frac) + afl_geo.zetaUpper[-1]
        lower_10deg_cone = midpoint_at_98_percent - np.tan(cone_angle/2/180*np.pi)*(1-te_frac) + afl_geo.zetaLower[-1]
